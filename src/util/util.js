...
/**
 * 简单继承操作
 * @param  {Object} _sub 子类
 * @param  {Object} _sup 父类
 * @return {Object}      子类原型对象
 */
var __doExtendClass = function(_sub,_sup){
    var f = function(){};
    f.prototype = _sup.prototype;
    _sub.prototype = new f();
    _sub.prototype.constructor = _sub;
    return _sub.prototype;
};
// export api
...
exports.extend  = __doExtendClass;